...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UINavigationController *masterNav = (UINavigationController*)splitController.viewControllers[0];
    [(AAPLListTableViewController*)masterNav.topViewController setUser:user];
...
- (UIViewController *)splitViewController:(UISplitViewController *)splitViewController separateSecondaryViewControllerFromPrimaryViewController:(UIViewController *)primaryViewController
{
    ...
    return [[self.window.rootViewController storyboard] instantiateViewControllerWithIdentifier:@"EmptyViewController"];
}
